...
const LANDING_I18N = {
  es: {
    ...
    voices: [
      { id: 'masculine_1', label: '🌌 Eric, Predeterminado', desc: 'Presencia clara y serena — guía con calma ancestral' },
      { id: 'masculine_2', label: '🔮 Zoltar, Calma',       desc: 'Eco del cosmos — profundo, hipnótico, inescrutable' },
      { id: 'feminine_1',  label: '🌸 Jane, Suave',         desc: 'Susurro sanador — etérea como la seda del tiempo' },
      { id: 'feminine_2',  label: '💜 Lily, Empatía',       desc: 'Abrazo de luz — cálida, cercana, eternamente compasiva' },
    ],
    begin_btn: '✦ Comenzar',
  ...
  en: {
    ...
    voices: [
      ...
      { id: 'feminine_2',  label: '💜 Lily, Empathy',  desc: 'Embrace of light — warm, near, eternally compassionate' },
    ],
    begin_btn: '✦ Begin',
  ...
  pt: {
    ...
    voices: [
      { id: 'masculine_1', label: '🌌 Eric, Padrão',    desc: 'Presença clara e serena — guia com calma ancestral' },
      { id: 'masculine_2', label: '🔮 Zoltar, Calmo',  desc: 'Eco do cosmos — profundo, hipnótico, inescrutável' },
      { id: 'feminine_1',  label: '🌸 Jane, Suave',    desc: 'Sussurro que cura — etéreo como a seda do tempo' },
      { id: 'feminine_2',  label: '💜 Lily, Empatia',  desc: 'Abraço de luz — caloroso, próximo, eternamente compassivo' },
    ],
    begin_btn: '✦ Começar',
